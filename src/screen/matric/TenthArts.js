...
import { tenthArtsQuestion } from '../../utils/questions';
import Loader from '../../component/Loader';


const TenthArts= ({navigation}) => {
  ...
  const [filterClass, setFilterClass] = useState(tenthArtsQuestion);
