...
import { firstYear, nineArtsQuestion } from '../../utils/questions';
import Loader from '../../component/Loader';


const NineArts = ({navigation}) => {
  ...
  const [filterClass, setFilterClass] = useState(nineArtsQuestion);
